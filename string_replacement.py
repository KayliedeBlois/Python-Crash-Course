...
rightJourney = journey.replace("tone", "town").replace("Leaving", "Living").replace("whirl", "world").replace("tray", "train").replace("seedy", "city").replace("Bored", "Born").replace("or something", "")
